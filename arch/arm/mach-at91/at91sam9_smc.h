...
#define ATMEL_BASE_SMC	 0xffffe400 // ATMEL_BASE_SMC0
#endif
...
typedef struct	at91_cs {
	uint32_t	setup;		/* 0x00 SMC Setup Register */
	uint32_t	pulse;		/* 0x04 SMC Pulse Register */
	uint32_t	cycle;		/* 0x08 SMC Cycle Register */
	uint32_t	mode;		/* 0x0C SMC Mode Register */
} at91_cs_t;
